...
•	These classes exist, but there are no claims: bblothia a2rbbblo bblothiathia cchbthia
*/
...
gen bblothia = 1 if hic3_desc=="BETA-ADRENERGIC BLOCKING AGENTS/THIAZIDE & RELATED"

keep if bblothia==1 

tempfile bblothia
save `bblothia', replace
...
///////////////// Array
forvalues d = 1/365{
	gen bblothia_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & bblothia==1
}

drop doy_srvc
xfill bblothia_a*, i(idn)

/////////////////bene-class timing
egen bblothia_fdays_2006 = sum(dayssply), by(idn)
egen bblothia_clms_2006 = count(dayssply), by(idn)
egen bblothia_minfilldt_2006 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2006 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2006 = bblothia_maxfilldt_2006 - bblothia_minfilldt_2006 + 1
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if bblothia_a`d'==1 & snf_a`d'==1

	//if the bblothia_a`d' is 1, do nothing (already added it to the snf_push)
	//if that bblothia_a spot is empty:
	gen v1 = 1 if snf_push>0 & bblothia_a`d'==.
	replace bblothia_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if bblothia_a`d'==1 & ips_a`d'==1

	//if the bblothia_a`d' is 1, do nothing (already added it to the ips_push)
	//if that bblothia_a spot is not full:
	gen v1 = 1 if ips_push>0 & bblothia_a`d'==.
	replace bblothia_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2006 = bblothia_pdays_2006 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2006 = 365 if bblothia_pdays_2006>365
...
egen bblothia_push_2006 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2006 = 0 if bblothia_push_2006==.
replace bblothia_push_2006 = 0 if bblothia_push_2006<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2006p.dta", replace

keep bene_id bblothia_push_2006
tempfile push
save `push', replace
...
replace pushstock = pushstock + bblothia_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2007 = sum(dayssply), by(idn)
egen bblothia_clms_2007 = count(dayssply), by(idn)
egen bblothia_minfilldt_2007 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2007 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2007 = bblothia_maxfilldt_2007 - bblothia_minfilldt_2007 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2007 = bblothia_pdays_2007 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2007 = 365 if bblothia_pdays_2007>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2007 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2007 = 0 if bblothia_push_2007==.
replace bblothia_push_2007 = 0 if bblothia_push_2007<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2007p.dta", replace

keep bene_id bblothia_push_2007
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2008 = sum(dayssply), by(idn)
egen bblothia_clms_2008 = count(dayssply), by(idn)
egen bblothia_minfilldt_2008 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2008 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2008 = bblothia_maxfilldt_2008 - bblothia_minfilldt_2008 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2008 = bblothia_pdays_2008 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2008 = 365 if bblothia_pdays_2008>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2008 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2008 = 0 if bblothia_push_2008==.
replace bblothia_push_2008 = 0 if bblothia_push_2008<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2008p.dta", replace

keep bene_id bblothia_push_2008
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2009 = sum(dayssply), by(idn)
egen bblothia_clms_2009 = count(dayssply), by(idn)
egen bblothia_minfilldt_2009 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2009 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2009 = bblothia_maxfilldt_2009 - bblothia_minfilldt_2009 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2009 = bblothia_pdays_2009 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2009 = 365 if bblothia_pdays_2009>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2009 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2009 = 0 if bblothia_push_2009==.
replace bblothia_push_2009 = 0 if bblothia_push_2009<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2009p.dta", replace

keep bene_id bblothia_push_2009
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2010 = sum(dayssply), by(idn)
egen bblothia_clms_2010 = count(dayssply), by(idn)
egen bblothia_minfilldt_2010 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2010 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2010 = bblothia_maxfilldt_2010 - bblothia_minfilldt_2010 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2010 = bblothia_pdays_2010 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2010 = 365 if bblothia_pdays_2010>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2010 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2010 = 0 if bblothia_push_2010==.
replace bblothia_push_2010 = 0 if bblothia_push_2010<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2010p.dta", replace

keep bene_id bblothia_push_2010
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2011 = sum(dayssply), by(idn)
egen bblothia_clms_2011 = count(dayssply), by(idn)
egen bblothia_minfilldt_2011 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2011 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2011 = bblothia_maxfilldt_2011 - bblothia_minfilldt_2011 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2011 = bblothia_pdays_2011 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2011 = 365 if bblothia_pdays_2011>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2011 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2011 = 0 if bblothia_push_2011==.
replace bblothia_push_2011 = 0 if bblothia_push_2011<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2011p.dta", replace

keep bene_id bblothia_push_2011
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2012 = sum(dayssply), by(idn)
egen bblothia_clms_2012 = count(dayssply), by(idn)
egen bblothia_minfilldt_2012 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2012 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2012 = bblothia_maxfilldt_2012 - bblothia_minfilldt_2012 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2012 = bblothia_pdays_2012 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2012 = 365 if bblothia_pdays_2012>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2012 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2012 = 0 if bblothia_push_2012==.
replace bblothia_push_2012 = 0 if bblothia_push_2012<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2012p.dta", replace

keep bene_id bblothia_push_2012
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bblothia_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bblothia_fdays_2013 = sum(dayssply), by(idn)
egen bblothia_clms_2013 = count(dayssply), by(idn)
egen bblothia_minfilldt_2013 = min(srvc_dt), by(idn)
egen bblothia_maxfilldt_2013 = max(srvc_dt), by(idn)
gen bblothia_fillperiod_2013 = bblothia_maxfilldt_2013 - bblothia_minfilldt_2013 + 1
...
*/
forvalues d = 1/365{
	replace bblothia_pdays_2013 = bblothia_pdays_2013 + 1 if bblothia_a`d'==1
}
drop bblothia_a*
replace bblothia_pdays_2013 = 365 if bblothia_pdays_2013>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bblothia_push_2013 = rowmax(lastfill_push inyear_push) 
replace bblothia_push_2013 = 0 if bblothia_push_2013==.
replace bblothia_push_2013 = 0 if bblothia_push_2013<0

keep bene_id bblothia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_2013p.dta", replace

////////////////////////////////////////////////////////////////////////////////
/////////////// 	Merge bblothia 07-13	////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
gen ybblothia2008 = 1
merge 1:1 bene_id using `bblothia'
drop _m
save `bblothia', replace
...
//timing variables
gen bblothia_firstyoo=.
gen bblothia_lastyoo=.
local years "2013 2012 2011 2010 2009 2008 2007"
foreach i in `years'{
	replace bblothia_firstyoo = `i' if ybblothia`i'==1
}
local years "2007 2008 2009 2010 2011 2012 2013"
foreach i in `years'{
	replace bblothia_lastyoo = `i' if ybblothia`i'==1
}
gen bblothia_yearcount = bblothia_lastyoo - bblothia_firstyoo + 1

//utilization variables 
forvalues i = 2007/2013{
	replace bblothia_fillperiod_`i' = 0 if bblothia_fillperiod_`i'==.
	replace bblothia_clms_`i' = 0 if bblothia_clms_`i'==.
	replace bblothia_fdays_`i' = 0 if bblothia_fdays_`i'==.
	replace bblothia_pdays_`i' = 0 if bblothia_pdays_`i'==.
}	
//minfilldt maxfilldt push

//total utilization
gen bblothia_clms = bblothia_clms_2007+bblothia_clms_2008+bblothia_clms_2009+bblothia_clms_2010+bblothia_clms_2011+bblothia_clms_2012+bblothia_clms_2013
gen bblothia_fdays = bblothia_fdays_2007+bblothia_fdays_2008+bblothia_fdays_2009+bblothia_fdays_2010+bblothia_fdays_2011+bblothia_fdays_2012+bblothia_fdays_2013
gen bblothia_pdays = bblothia_pdays_2007+bblothia_pdays_2008+bblothia_pdays_2009+bblothia_pdays_2010+bblothia_pdays_2011+bblothia_pdays_2012+bblothia_pdays_2013

//timing variables 
egen bblothia_minfilldt = rowmin(bblothia_minfilldt_2007 bblothia_minfilldt_2008 bblothia_minfilldt_2009 bblothia_minfilldt_2010 bblothia_minfilldt_2011 bblothia_minfilldt_2012 bblothia_minfilldt_2013)
egen bblothia_maxfilldt = rowmax(bblothia_maxfilldt_2007 bblothia_maxfilldt_2008 bblothia_maxfilldt_2009 bblothia_maxfilldt_2010 bblothia_maxfilldt_2011 bblothia_maxfilldt_2012 bblothia_maxfilldt_2013)

gen bblothia_fillperiod = bblothia_maxfilldt - bblothia_minfilldt + 1

gen bblothia_pdayspy = bblothia_pdays/bblothia_yearcount
gen bblothia_fdayspy = bblothia_fdays/bblothia_yearcount
gen bblothia_clmspy = bblothia_clms/bblothia_yearcount

sort bene_id
drop if bene_id==bene_id[_n-1]

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bblothia_0713p.dta", replace
