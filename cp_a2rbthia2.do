...
gen a2rbthia = 1 if hic3_desc=="ANGIOTENSIN RECEPTOR ANTAG.-THIAZIDE DIURETIC COMB"

keep if a2rbthia==1 

tempfile a2rbthia
save `a2rbthia', replace
/*
////////////////////////////////////////////////////////////////////////////////
///////////////////////			a2rbthia pull			////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
///////////////// Array
forvalues d = 1/365{
	gen a2rbthia_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & a2rbthia==1
}

drop doy_srvc
xfill a2rbthia_a*, i(idn)

/////////////////bene-class timing
egen a2rbthia_fdays_2006 = sum(dayssply), by(idn)
egen a2rbthia_clms_2006 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2006 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2006 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2006 = a2rbthia_maxfilldt_2006 - a2rbthia_minfilldt_2006 + 1
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if a2rbthia_a`d'==1 & snf_a`d'==1

	//if the a2rbthia_a`d' is 1, do nothing (already added it to the snf_push)
	//if that a2rbthia_a spot is empty:
	gen v1 = 1 if snf_push>0 & a2rbthia_a`d'==.
	replace a2rbthia_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if a2rbthia_a`d'==1 & ips_a`d'==1

	//if the a2rbthia_a`d' is 1, do nothing (already added it to the ips_push)
	//if that a2rbthia_a spot is not full:
	gen v1 = 1 if ips_push>0 & a2rbthia_a`d'==.
	replace a2rbthia_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2006 = a2rbthia_pdays_2006 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2006 = 365 if a2rbthia_pdays_2006>365
...
egen a2rbthia_push_2006 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2006 = 0 if a2rbthia_push_2006==.
replace a2rbthia_push_2006 = 0 if a2rbthia_push_2006<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2006p.dta", replace

keep bene_id a2rbthia_push_2006
tempfile push
save `push', replace
...
replace pushstock = pushstock + a2rbthia_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2007 = sum(dayssply), by(idn)
egen a2rbthia_clms_2007 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2007 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2007 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2007 = a2rbthia_maxfilldt_2007 - a2rbthia_minfilldt_2007 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2007 = a2rbthia_pdays_2007 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2007 = 365 if a2rbthia_pdays_2007>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2007 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2007 = 0 if a2rbthia_push_2007==.
replace a2rbthia_push_2007 = 0 if a2rbthia_push_2007<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2007p.dta", replace

keep bene_id a2rbthia_push_2007
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2008 = sum(dayssply), by(idn)
egen a2rbthia_clms_2008 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2008 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2008 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2008 = a2rbthia_maxfilldt_2008 - a2rbthia_minfilldt_2008 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2008 = a2rbthia_pdays_2008 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2008 = 365 if a2rbthia_pdays_2008>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2008 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2008 = 0 if a2rbthia_push_2008==.
replace a2rbthia_push_2008 = 0 if a2rbthia_push_2008<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2008p.dta", replace

keep bene_id a2rbthia_push_2008
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2009 = sum(dayssply), by(idn)
egen a2rbthia_clms_2009 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2009 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2009 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2009 = a2rbthia_maxfilldt_2009 - a2rbthia_minfilldt_2009 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2009 = a2rbthia_pdays_2009 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2009 = 365 if a2rbthia_pdays_2009>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2009 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2009 = 0 if a2rbthia_push_2009==.
replace a2rbthia_push_2009 = 0 if a2rbthia_push_2009<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2009p.dta", replace

keep bene_id a2rbthia_push_2009
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2010 = sum(dayssply), by(idn)
egen a2rbthia_clms_2010 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2010 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2010 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2010 = a2rbthia_maxfilldt_2010 - a2rbthia_minfilldt_2010 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2010 = a2rbthia_pdays_2010 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2010 = 365 if a2rbthia_pdays_2010>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2010 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2010 = 0 if a2rbthia_push_2010==.
replace a2rbthia_push_2010 = 0 if a2rbthia_push_2010<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2010p.dta", replace

keep bene_id a2rbthia_push_2010
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2011 = sum(dayssply), by(idn)
egen a2rbthia_clms_2011 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2011 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2011 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2011 = a2rbthia_maxfilldt_2011 - a2rbthia_minfilldt_2011 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2011 = a2rbthia_pdays_2011 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2011 = 365 if a2rbthia_pdays_2011>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2011 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2011 = 0 if a2rbthia_push_2011==.
replace a2rbthia_push_2011 = 0 if a2rbthia_push_2011<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2011p.dta", replace

use "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2011p.dta", replace

keep bene_id a2rbthia_push_2011
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2012 = sum(dayssply), by(idn)
egen a2rbthia_clms_2012 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2012 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2012 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2012 = a2rbthia_maxfilldt_2012 - a2rbthia_minfilldt_2012 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2012 = a2rbthia_pdays_2012 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2012 = 365 if a2rbthia_pdays_2012>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2012 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2012 = 0 if a2rbthia_push_2012==.
replace a2rbthia_push_2012 = 0 if a2rbthia_push_2012<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2012p.dta", replace
*/
use "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2012p.dta", replace

keep bene_id a2rbthia_push_2012
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbthia_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbthia_fdays_2013 = sum(dayssply), by(idn)
egen a2rbthia_clms_2013 = count(dayssply), by(idn)
egen a2rbthia_minfilldt_2013 = min(srvc_dt), by(idn)
egen a2rbthia_maxfilldt_2013 = max(srvc_dt), by(idn)
gen a2rbthia_fillperiod_2013 = a2rbthia_maxfilldt_2013 - a2rbthia_minfilldt_2013 + 1
...
*/
forvalues d = 1/365{
	replace a2rbthia_pdays_2013 = a2rbthia_pdays_2013 + 1 if a2rbthia_a`d'==1
}
drop a2rbthia_a*
replace a2rbthia_pdays_2013 = 365 if a2rbthia_pdays_2013>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbthia_push_2013 = rowmax(lastfill_push inyear_push) 
replace a2rbthia_push_2013 = 0 if a2rbthia_push_2013==.
replace a2rbthia_push_2013 = 0 if a2rbthia_push_2013<0

keep bene_id a2rbthia* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_2013p.dta", replace
...
gen ya2rbthia2008 = 1
merge 1:1 bene_id using `a2rbthia'
drop _m
save `a2rbthia', replace
...
//timing variables
gen a2rbthia_firstyoo=.
gen a2rbthia_lastyoo=.
local years "2013 2012 2011 2010 2009 2008 2007"
foreach i in `years'{
	replace a2rbthia_firstyoo = `i' if ya2rbthia`i'==1
}
local years "2007 2008 2009 2010 2011 2012 2013"
foreach i in `years'{
	replace a2rbthia_lastyoo = `i' if ya2rbthia`i'==1
}
gen a2rbthia_yearcount = a2rbthia_lastyoo - a2rbthia_firstyoo + 1

//utilization variables 
forvalues i = 2007/2013{
	replace a2rbthia_fillperiod_`i' = 0 if a2rbthia_fillperiod_`i'==.
	replace a2rbthia_clms_`i' = 0 if a2rbthia_clms_`i'==.
	replace a2rbthia_fdays_`i' = 0 if a2rbthia_fdays_`i'==.
	replace a2rbthia_pdays_`i' = 0 if a2rbthia_pdays_`i'==.
}	
//minfilldt maxfilldt push

//total utilization
gen a2rbthia_clms = a2rbthia_clms_2007+a2rbthia_clms_2008+a2rbthia_clms_2009+a2rbthia_clms_2010+a2rbthia_clms_2011+a2rbthia_clms_2012+a2rbthia_clms_2013
gen a2rbthia_fdays = a2rbthia_fdays_2007+a2rbthia_fdays_2008+a2rbthia_fdays_2009+a2rbthia_fdays_2010+a2rbthia_fdays_2011+a2rbthia_fdays_2012+a2rbthia_fdays_2013
gen a2rbthia_pdays = a2rbthia_pdays_2007+a2rbthia_pdays_2008+a2rbthia_pdays_2009+a2rbthia_pdays_2010+a2rbthia_pdays_2011+a2rbthia_pdays_2012+a2rbthia_pdays_2013

//timing variables 
egen a2rbthia_minfilldt = rowmin(a2rbthia_minfilldt_2007 a2rbthia_minfilldt_2008 a2rbthia_minfilldt_2009 a2rbthia_minfilldt_2010 a2rbthia_minfilldt_2011 a2rbthia_minfilldt_2012 a2rbthia_minfilldt_2013)
egen a2rbthia_maxfilldt = rowmax(a2rbthia_maxfilldt_2007 a2rbthia_maxfilldt_2008 a2rbthia_maxfilldt_2009 a2rbthia_maxfilldt_2010 a2rbthia_maxfilldt_2011 a2rbthia_maxfilldt_2012 a2rbthia_maxfilldt_2013)

gen a2rbthia_fillperiod = a2rbthia_maxfilldt - a2rbthia_minfilldt + 1

gen a2rbthia_pdayspy = a2rbthia_pdays/a2rbthia_yearcount
gen a2rbthia_fdayspy = a2rbthia_fdays/a2rbthia_yearcount
gen a2rbthia_clmspy = a2rbthia_clms/a2rbthia_yearcount

sort bene_id
drop if bene_id==bene_id[_n-1]

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbthia_0713p.dta", replace
