...
gen a2rbso = 1 if hic3_desc=="ANTIHYPERTENSIVES, ANGIOTENSIN RECEPTOR ANTAGONIST" | ///
	hic3_desc=="RENIN INHIBITOR,DIRECT & ANGIOTENSIN RECEPT ANTAG." | ///
	hic3_desc=="ANGIOTENSIN RECEPT-NEPRILYSIN INHIBITOR COMB(ARNI)" 
...
///////////////// Array
forvalues d = 1/365{
	gen a2rbso_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & a2rbso==1
}

drop doy_srvc
xfill a2rbso_a*, i(idn)

/////////////////bene-class timing
egen a2rbso_fdays_2006 = sum(dayssply), by(idn)
egen a2rbso_clms_2006 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2006 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2006 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2006 = a2rbso_maxfilldt_2006 - a2rbso_minfilldt_2006 + 1
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if a2rbso_a`d'==1 & snf_a`d'==1

	//if the a2rbso_a`d' is 1, do nothing (already added it to the snf_push)
	//if that a2rbso_a spot is empty:
	gen v1 = 1 if snf_push>0 & a2rbso_a`d'==.
	replace a2rbso_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if a2rbso_a`d'==1 & ips_a`d'==1

	//if the a2rbso_a`d' is 1, do nothing (already added it to the ips_push)
	//if that a2rbso_a spot is not full:
	gen v1 = 1 if ips_push>0 & a2rbso_a`d'==.
	replace a2rbso_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2006 = a2rbso_pdays_2006 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2006 = 365 if a2rbso_pdays_2006>365
...
egen a2rbso_push_2006 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2006 = 0 if a2rbso_push_2006==.
replace a2rbso_push_2006 = 0 if a2rbso_push_2006<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2006p.dta", replace

keep bene_id a2rbso_push_2006
tempfile push
save `push', replace
...
replace pushstock = pushstock + a2rbso_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2007 = sum(dayssply), by(idn)
egen a2rbso_clms_2007 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2007 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2007 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2007 = a2rbso_maxfilldt_2007 - a2rbso_minfilldt_2007 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2007 = a2rbso_pdays_2007 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2007 = 365 if a2rbso_pdays_2007>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2007 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2007 = 0 if a2rbso_push_2007==.
replace a2rbso_push_2007 = 0 if a2rbso_push_2007<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2007p.dta", replace

keep bene_id a2rbso_push_2007
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2008 = sum(dayssply), by(idn)
egen a2rbso_clms_2008 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2008 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2008 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2008 = a2rbso_maxfilldt_2008 - a2rbso_minfilldt_2008 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2008 = a2rbso_pdays_2008 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2008 = 365 if a2rbso_pdays_2008>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2008 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2008 = 0 if a2rbso_push_2008==.
replace a2rbso_push_2008 = 0 if a2rbso_push_2008<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2008p.dta", replace

keep bene_id a2rbso_push_2008
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2009 = sum(dayssply), by(idn)
egen a2rbso_clms_2009 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2009 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2009 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2009 = a2rbso_maxfilldt_2009 - a2rbso_minfilldt_2009 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2009 = a2rbso_pdays_2009 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2009 = 365 if a2rbso_pdays_2009>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2009 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2009 = 0 if a2rbso_push_2009==.
replace a2rbso_push_2009 = 0 if a2rbso_push_2009<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2009p.dta", replace

keep bene_id a2rbso_push_2009
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2010 = sum(dayssply), by(idn)
egen a2rbso_clms_2010 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2010 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2010 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2010 = a2rbso_maxfilldt_2010 - a2rbso_minfilldt_2010 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2010 = a2rbso_pdays_2010 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2010 = 365 if a2rbso_pdays_2010>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2010 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2010 = 0 if a2rbso_push_2010==.
replace a2rbso_push_2010 = 0 if a2rbso_push_2010<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2010p.dta", replace

keep bene_id a2rbso_push_2010
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2011 = sum(dayssply), by(idn)
egen a2rbso_clms_2011 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2011 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2011 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2011 = a2rbso_maxfilldt_2011 - a2rbso_minfilldt_2011 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2011 = a2rbso_pdays_2011 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2011 = 365 if a2rbso_pdays_2011>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2011 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2011 = 0 if a2rbso_push_2011==.
replace a2rbso_push_2011 = 0 if a2rbso_push_2011<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2011p.dta", replace

use "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2011p.dta", replace

keep bene_id a2rbso_push_2011
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2012 = sum(dayssply), by(idn)
egen a2rbso_clms_2012 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2012 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2012 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2012 = a2rbso_maxfilldt_2012 - a2rbso_minfilldt_2012 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2012 = a2rbso_pdays_2012 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2012 = 365 if a2rbso_pdays_2012>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2012 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2012 = 0 if a2rbso_push_2012==.
replace a2rbso_push_2012 = 0 if a2rbso_push_2012<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2012p.dta", replace
*/
use "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2012p.dta", replace

keep bene_id a2rbso_push_2012
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + a2rbso_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen a2rbso_fdays_2013 = sum(dayssply), by(idn)
egen a2rbso_clms_2013 = count(dayssply), by(idn)
egen a2rbso_minfilldt_2013 = min(srvc_dt), by(idn)
egen a2rbso_maxfilldt_2013 = max(srvc_dt), by(idn)
gen a2rbso_fillperiod_2013 = a2rbso_maxfilldt_2013 - a2rbso_minfilldt_2013 + 1
...
*/
forvalues d = 1/365{
	replace a2rbso_pdays_2013 = a2rbso_pdays_2013 + 1 if a2rbso_a`d'==1
}
drop a2rbso_a*
replace a2rbso_pdays_2013 = 365 if a2rbso_pdays_2013>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen a2rbso_push_2013 = rowmax(lastfill_push inyear_push) 
replace a2rbso_push_2013 = 0 if a2rbso_push_2013==.
replace a2rbso_push_2013 = 0 if a2rbso_push_2013<0

keep bene_id a2rbso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_2013p.dta", replace
...
gen ya2rbso2008 = 1
merge 1:1 bene_id using `a2rbso'
drop _m
save `a2rbso', replace
...
foreach i in `years'{
	replace a2rbso_firstyoo = `i' if ya2rbso`i'==1
}
local years "2007 2008 2009 2010 2011 2012 2013"
foreach i in `years'{
	replace a2rbso_lastyoo = `i' if ya2rbso`i'==1
}
gen a2rbso_yearcount = a2rbso_lastyoo - a2rbso_firstyoo + 1

//utilization variables 
forvalues i = 2007/2013{
	replace a2rbso_fillperiod_`i' = 0 if a2rbso_fillperiod_`i'==.
	replace a2rbso_clms_`i' = 0 if a2rbso_clms_`i'==.
	replace a2rbso_fdays_`i' = 0 if a2rbso_fdays_`i'==.
	replace a2rbso_pdays_`i' = 0 if a2rbso_pdays_`i'==.
}	
//minfilldt maxfilldt push

//total utilization
gen a2rbso_clms = a2rbso_clms_2007+a2rbso_clms_2008+a2rbso_clms_2009+a2rbso_clms_2010+a2rbso_clms_2011+a2rbso_clms_2012+a2rbso_clms_2013
gen a2rbso_fdays = a2rbso_fdays_2007+a2rbso_fdays_2008+a2rbso_fdays_2009+a2rbso_fdays_2010+a2rbso_fdays_2011+a2rbso_fdays_2012+a2rbso_fdays_2013
gen a2rbso_pdays = a2rbso_pdays_2007+a2rbso_pdays_2008+a2rbso_pdays_2009+a2rbso_pdays_2010+a2rbso_pdays_2011+a2rbso_pdays_2012+a2rbso_pdays_2013

//timing variables 
egen a2rbso_minfilldt = rowmin(a2rbso_minfilldt_2007 a2rbso_minfilldt_2008 a2rbso_minfilldt_2009 a2rbso_minfilldt_2010 a2rbso_minfilldt_2011 a2rbso_minfilldt_2012 a2rbso_minfilldt_2013)
egen a2rbso_maxfilldt = rowmax(a2rbso_maxfilldt_2007 a2rbso_maxfilldt_2008 a2rbso_maxfilldt_2009 a2rbso_maxfilldt_2010 a2rbso_maxfilldt_2011 a2rbso_maxfilldt_2012 a2rbso_maxfilldt_2013)

gen a2rbso_fillperiod = a2rbso_maxfilldt - a2rbso_minfilldt + 1

gen a2rbso_pdayspy = a2rbso_pdays/a2rbso_yearcount
gen a2rbso_fdayspy = a2rbso_fdays/a2rbso_yearcount
gen a2rbso_clmspy = a2rbso_clms/a2rbso_yearcount

sort bene_id
drop if bene_id==bene_id[_n-1]

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/a2rbso_0713p.dta", replace
