...
•	These classes exist, but there are no claims: rivas a2rbbblo rivasthia cchbthia
*/
...
egen rivas = anymatch(ndcn), values(00078050115 00078050161 00078050215 00078050261 00078050315 00078050361 21695035730  ///
35356039430 54868595400 54868607000  ///
00078032306 00078032315 00078032344 00078032361 00078032406 00078032415 00078032444  ///
00078032506 00078032515 00078032544 00078032606 00078032615 00078032644 00078033931  ///
00591320860 00591320960 00591321060 00591321160 00781261413 00781261460 00781261513  ///
00781261560 00781261613 00781261660 00781261713 00781261760 12280038960 51991079306  ///
51991079406 51991079506 51991079606 54868451200 54868451201 54868524000 54868533900  ///
54868583900 55111035205 55111035260 55111035360 55111035405 55111035460 55111035560  ///
62756014513 62756014586 62756014613 62756014686 62756014713 62756014786 62756014813  ///
62756014886 68084055001)
...
///////////////// Array
forvalues d = 1/365{
	gen rivas_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & rivas==1
}
...
/////////////////bene-class timing
egen rivas_fdays_2006 = sum(dayssply), by(idn)
egen rivas_clms_2006 = count(dayssply), by(idn)
egen rivas_minfilldt_2006 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2006 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2006 = rivas_maxfilldt_2006 - rivas_minfilldt_2006 + 1
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if rivas_a`d'==1 & snf_a`d'==1

	//if the rivas_a`d' is 1, do nothing (already added it to the snf_push)
	//if that rivas_a spot is empty:
	gen v1 = 1 if snf_push>0 & rivas_a`d'==.
	replace rivas_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if rivas_a`d'==1 & ips_a`d'==1

	//if the rivas_a`d' is 1, do nothing (already added it to the ips_push)
	//if that rivas_a spot is not full:
	gen v1 = 1 if ips_push>0 & rivas_a`d'==.
	replace rivas_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2006 = rivas_pdays_2006 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2006 = 365 if rivas_pdays_2006>365
...
egen rivas_push_2006 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2006 = 0 if rivas_push_2006==.
replace rivas_push_2006 = 0 if rivas_push_2006<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2006p.dta", replace

keep bene_id rivas_push_2006
tempfile push
save `push', replace
...
replace pushstock = pushstock + rivas_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2007 = sum(dayssply), by(idn)
egen rivas_clms_2007 = count(dayssply), by(idn)
egen rivas_minfilldt_2007 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2007 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2007 = rivas_maxfilldt_2007 - rivas_minfilldt_2007 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2007 = rivas_pdays_2007 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2007 = 365 if rivas_pdays_2007>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2007 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2007 = 0 if rivas_push_2007==.
replace rivas_push_2007 = 0 if rivas_push_2007<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2007p.dta", replace

keep bene_id rivas_push_2007
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2008 = sum(dayssply), by(idn)
egen rivas_clms_2008 = count(dayssply), by(idn)
egen rivas_minfilldt_2008 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2008 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2008 = rivas_maxfilldt_2008 - rivas_minfilldt_2008 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2008 = rivas_pdays_2008 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2008 = 365 if rivas_pdays_2008>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2008 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2008 = 0 if rivas_push_2008==.
replace rivas_push_2008 = 0 if rivas_push_2008<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2008p.dta", replace

keep bene_id rivas_push_2008
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2009 = sum(dayssply), by(idn)
egen rivas_clms_2009 = count(dayssply), by(idn)
egen rivas_minfilldt_2009 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2009 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2009 = rivas_maxfilldt_2009 - rivas_minfilldt_2009 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2009 = rivas_pdays_2009 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2009 = 365 if rivas_pdays_2009>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2009 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2009 = 0 if rivas_push_2009==.
replace rivas_push_2009 = 0 if rivas_push_2009<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2009p.dta", replace

keep bene_id rivas_push_2009
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2010 = sum(dayssply), by(idn)
egen rivas_clms_2010 = count(dayssply), by(idn)
egen rivas_minfilldt_2010 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2010 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2010 = rivas_maxfilldt_2010 - rivas_minfilldt_2010 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2010 = rivas_pdays_2010 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2010 = 365 if rivas_pdays_2010>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2010 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2010 = 0 if rivas_push_2010==.
replace rivas_push_2010 = 0 if rivas_push_2010<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2010p.dta", replace

keep bene_id rivas_push_2010
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2011 = sum(dayssply), by(idn)
egen rivas_clms_2011 = count(dayssply), by(idn)
egen rivas_minfilldt_2011 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2011 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2011 = rivas_maxfilldt_2011 - rivas_minfilldt_2011 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2011 = rivas_pdays_2011 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2011 = 365 if rivas_pdays_2011>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2011 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2011 = 0 if rivas_push_2011==.
replace rivas_push_2011 = 0 if rivas_push_2011<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2011p.dta", replace

keep bene_id rivas_push_2011
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2012 = sum(dayssply), by(idn)
egen rivas_clms_2012 = count(dayssply), by(idn)
egen rivas_minfilldt_2012 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2012 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2012 = rivas_maxfilldt_2012 - rivas_minfilldt_2012 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2012 = rivas_pdays_2012 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2012 = 365 if rivas_pdays_2012>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2012 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2012 = 0 if rivas_push_2012==.
replace rivas_push_2012 = 0 if rivas_push_2012<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2012p.dta", replace

keep bene_id rivas_push_2012
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + rivas_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen rivas_fdays_2013 = sum(dayssply), by(idn)
egen rivas_clms_2013 = count(dayssply), by(idn)
egen rivas_minfilldt_2013 = min(srvc_dt), by(idn)
egen rivas_maxfilldt_2013 = max(srvc_dt), by(idn)
gen rivas_fillperiod_2013 = rivas_maxfilldt_2013 - rivas_minfilldt_2013 + 1
...
*/
forvalues d = 1/365{
	replace rivas_pdays_2013 = rivas_pdays_2013 + 1 if rivas_a`d'==1
}
drop rivas_a*
replace rivas_pdays_2013 = 365 if rivas_pdays_2013>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen rivas_push_2013 = rowmax(lastfill_push inyear_push) 
replace rivas_push_2013 = 0 if rivas_push_2013==.
replace rivas_push_2013 = 0 if rivas_push_2013<0

keep bene_id rivas* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_2013p.dta", replace
...
foreach i in `years'{
	replace rivas_firstyoo = `i' if yrivas`i'==1
}
local years "2007 2008 2009 2010 2011 2012 2013"
foreach i in `years'{
	replace rivas_lastyoo = `i' if yrivas`i'==1
}
gen rivas_yearcount = rivas_lastyoo - rivas_firstyoo + 1

//utilization variables 
forvalues i = 2007/2013{
	replace rivas_fillperiod_`i' = 0 if rivas_fillperiod_`i'==.
	replace rivas_clms_`i' = 0 if rivas_clms_`i'==.
	replace rivas_fdays_`i' = 0 if rivas_fdays_`i'==.
	replace rivas_pdays_`i' = 0 if rivas_pdays_`i'==.
}	
//minfilldt maxfilldt push

//total utilization
gen rivas_clms = rivas_clms_2007+rivas_clms_2008+rivas_clms_2009+rivas_clms_2010+rivas_clms_2011+rivas_clms_2012+rivas_clms_2013
gen rivas_fdays = rivas_fdays_2007+rivas_fdays_2008+rivas_fdays_2009+rivas_fdays_2010+rivas_fdays_2011+rivas_fdays_2012+rivas_fdays_2013
gen rivas_pdays = rivas_pdays_2007+rivas_pdays_2008+rivas_pdays_2009+rivas_pdays_2010+rivas_pdays_2011+rivas_pdays_2012+rivas_pdays_2013

//timing variables 
egen rivas_minfilldt = rowmin(rivas_minfilldt_2007 rivas_minfilldt_2008 rivas_minfilldt_2009 rivas_minfilldt_2010 rivas_minfilldt_2011 rivas_minfilldt_2012 rivas_minfilldt_2013)
egen rivas_maxfilldt = rowmax(rivas_maxfilldt_2007 rivas_maxfilldt_2008 rivas_maxfilldt_2009 rivas_maxfilldt_2010 rivas_maxfilldt_2011 rivas_maxfilldt_2012 rivas_maxfilldt_2013)

gen rivas_fillperiod = rivas_maxfilldt - rivas_minfilldt + 1

gen rivas_pdayspy = rivas_pdays/rivas_yearcount
gen rivas_fdayspy = rivas_fdays/rivas_yearcount
gen rivas_clmspy = rivas_clms/rivas_yearcount

sort bene_id
drop if bene_id==bene_id[_n-1]

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/ADdrug/rivas_0713p.dta", replace
