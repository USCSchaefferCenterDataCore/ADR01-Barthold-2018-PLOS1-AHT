...
////////////////////////////////////////////////////////////////////////////////
//																			  //
//			Merge in AD info, and CCW info, geoedu, statins, adrx			  //
//																			  //
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
foreach i in `vars'{
	gen `i'_user = 0
	replace `i'_user = 1 if `i'_pdays>=90 & `i'_clms>=2
}
...
foreach i in `vars'{
	gen `i'_user_L1 = 0
	replace `i'_user_L1 = 1 if `i'_pdays[_n-1]>=90 & `i'_clms[_n-1]>=2 & bene_id==bene_id[_n-1]
	replace `i'_user_L1 = . if year==2007
	
	gen `i'_user_L12 = 0
	replace `i'_user_L12 = 1 if `i'_pdays[_n-1]>=90 & `i'_pdays[_n-2]>=90 & `i'_clms[_n-1]>=2 & `i'_clms[_n-2]>=2 & bene_id==bene_id[_n-1] & bene_id==bene_id[_n-2]
	replace `i'_user_L12 = . if year==2007 | year==2008  

	gen `i'_user_L2 = 0
	replace `i'_user_L2 = 1 if `i'_pdays[_n-2]>=90 & `i'_clms[_n-2]>=2 & bene_id==bene_id[_n-2]
...
compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/ahtco_long0713c902.dta", replace
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
use "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/ahtco_long0713c902.dta", replace
egen idn = group(bene_id)
sort bene_id year
...
*/
compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/ahtco_long0713_902.dta", replace
