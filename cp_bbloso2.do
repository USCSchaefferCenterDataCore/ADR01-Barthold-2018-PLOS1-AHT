...
•	These classes exist, but there are no claims: bbloso a2rbbblo bblosothia cchbthia
*/
...
gen bbloso = 1 if hic3_desc=="BETA-ADRENERGIC BLOCKING AGENTS" | hic3_desc=="ALPHA/BETA-ADRENERGIC BLOCKING AGENTS" | ///
	hic3_desc=="BETA-ADRENERGIC BLOCKING AGENTS/DIETARY SUPP COMB." 
...
///////////////// Array
forvalues d = 1/365{
	gen bbloso_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & bbloso==1
}

drop doy_srvc
xfill bbloso_a*, i(idn)

/////////////////bene-class timing
egen bbloso_fdays_2006 = sum(dayssply), by(idn)
egen bbloso_clms_2006 = count(dayssply), by(idn)
egen bbloso_minfilldt_2006 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2006 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2006 = bbloso_maxfilldt_2006 - bbloso_minfilldt_2006 + 1
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if bbloso_a`d'==1 & snf_a`d'==1

	//if the bbloso_a`d' is 1, do nothing (already added it to the snf_push)
	//if that bbloso_a spot is empty:
	gen v1 = 1 if snf_push>0 & bbloso_a`d'==.
	replace bbloso_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if bbloso_a`d'==1 & ips_a`d'==1

	//if the bbloso_a`d' is 1, do nothing (already added it to the ips_push)
	//if that bbloso_a spot is not full:
	gen v1 = 1 if ips_push>0 & bbloso_a`d'==.
	replace bbloso_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2006 = bbloso_pdays_2006 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2006 = 365 if bbloso_pdays_2006>365
...
egen bbloso_push_2006 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2006 = 0 if bbloso_push_2006==.
replace bbloso_push_2006 = 0 if bbloso_push_2006<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2006p.dta", replace

keep bene_id bbloso_push_2006
tempfile push
save `push', replace
...
replace pushstock = pushstock + bbloso_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2007 = sum(dayssply), by(idn)
egen bbloso_clms_2007 = count(dayssply), by(idn)
egen bbloso_minfilldt_2007 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2007 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2007 = bbloso_maxfilldt_2007 - bbloso_minfilldt_2007 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2007 = bbloso_pdays_2007 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2007 = 365 if bbloso_pdays_2007>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2007 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2007 = 0 if bbloso_push_2007==.
replace bbloso_push_2007 = 0 if bbloso_push_2007<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2007p.dta", replace

keep bene_id bbloso_push_2007
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2008 = sum(dayssply), by(idn)
egen bbloso_clms_2008 = count(dayssply), by(idn)
egen bbloso_minfilldt_2008 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2008 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2008 = bbloso_maxfilldt_2008 - bbloso_minfilldt_2008 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2008 = bbloso_pdays_2008 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2008 = 365 if bbloso_pdays_2008>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2008 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2008 = 0 if bbloso_push_2008==.
replace bbloso_push_2008 = 0 if bbloso_push_2008<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2008p.dta", replace

keep bene_id bbloso_push_2008
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2009 = sum(dayssply), by(idn)
egen bbloso_clms_2009 = count(dayssply), by(idn)
egen bbloso_minfilldt_2009 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2009 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2009 = bbloso_maxfilldt_2009 - bbloso_minfilldt_2009 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2009 = bbloso_pdays_2009 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2009 = 365 if bbloso_pdays_2009>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2009 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2009 = 0 if bbloso_push_2009==.
replace bbloso_push_2009 = 0 if bbloso_push_2009<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2009p.dta", replace

keep bene_id bbloso_push_2009
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2010 = sum(dayssply), by(idn)
egen bbloso_clms_2010 = count(dayssply), by(idn)
egen bbloso_minfilldt_2010 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2010 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2010 = bbloso_maxfilldt_2010 - bbloso_minfilldt_2010 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2010 = bbloso_pdays_2010 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2010 = 365 if bbloso_pdays_2010>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2010 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2010 = 0 if bbloso_push_2010==.
replace bbloso_push_2010 = 0 if bbloso_push_2010<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2010p.dta", replace

keep bene_id bbloso_push_2010
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2011 = sum(dayssply), by(idn)
egen bbloso_clms_2011 = count(dayssply), by(idn)
egen bbloso_minfilldt_2011 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2011 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2011 = bbloso_maxfilldt_2011 - bbloso_minfilldt_2011 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2011 = bbloso_pdays_2011 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2011 = 365 if bbloso_pdays_2011>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2011 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2011 = 0 if bbloso_push_2011==.
replace bbloso_push_2011 = 0 if bbloso_push_2011<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2011p.dta", replace

keep bene_id bbloso_push_2011
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2012 = sum(dayssply), by(idn)
egen bbloso_clms_2012 = count(dayssply), by(idn)
egen bbloso_minfilldt_2012 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2012 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2012 = bbloso_maxfilldt_2012 - bbloso_minfilldt_2012 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2012 = bbloso_pdays_2012 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2012 = 365 if bbloso_pdays_2012>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2012 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2012 = 0 if bbloso_push_2012==.
replace bbloso_push_2012 = 0 if bbloso_push_2012<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2012p.dta", replace

keep bene_id bbloso_push_2012
tempfile push
save `push', replace
...
//add the pushstock from last year
replace pushstock = pushstock + bbloso_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen bbloso_fdays_2013 = sum(dayssply), by(idn)
egen bbloso_clms_2013 = count(dayssply), by(idn)
egen bbloso_minfilldt_2013 = min(srvc_dt), by(idn)
egen bbloso_maxfilldt_2013 = max(srvc_dt), by(idn)
gen bbloso_fillperiod_2013 = bbloso_maxfilldt_2013 - bbloso_minfilldt_2013 + 1
...
*/
forvalues d = 1/365{
	replace bbloso_pdays_2013 = bbloso_pdays_2013 + 1 if bbloso_a`d'==1
}
drop bbloso_a*
replace bbloso_pdays_2013 = 365 if bbloso_pdays_2013>365
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen bbloso_push_2013 = rowmax(lastfill_push inyear_push) 
replace bbloso_push_2013 = 0 if bbloso_push_2013==.
replace bbloso_push_2013 = 0 if bbloso_push_2013<0

keep bene_id bbloso* 

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_2013p.dta", replace
...
gen ybbloso2008 = 1
merge 1:1 bene_id using `bbloso'
drop _m
save `bbloso', replace
...
foreach i in `years'{
	replace bbloso_firstyoo = `i' if ybbloso`i'==1
}
local years "2007 2008 2009 2010 2011 2012 2013"
foreach i in `years'{
	replace bbloso_lastyoo = `i' if ybbloso`i'==1
}
gen bbloso_yearcount = bbloso_lastyoo - bbloso_firstyoo + 1

//utilization variables 
forvalues i = 2007/2013{
	replace bbloso_fillperiod_`i' = 0 if bbloso_fillperiod_`i'==.
	replace bbloso_clms_`i' = 0 if bbloso_clms_`i'==.
	replace bbloso_fdays_`i' = 0 if bbloso_fdays_`i'==.
	replace bbloso_pdays_`i' = 0 if bbloso_pdays_`i'==.
}	
//minfilldt maxfilldt push

//total utilization
gen bbloso_clms = bbloso_clms_2007+bbloso_clms_2008+bbloso_clms_2009+bbloso_clms_2010+bbloso_clms_2011+bbloso_clms_2012+bbloso_clms_2013
gen bbloso_fdays = bbloso_fdays_2007+bbloso_fdays_2008+bbloso_fdays_2009+bbloso_fdays_2010+bbloso_fdays_2011+bbloso_fdays_2012+bbloso_fdays_2013
gen bbloso_pdays = bbloso_pdays_2007+bbloso_pdays_2008+bbloso_pdays_2009+bbloso_pdays_2010+bbloso_pdays_2011+bbloso_pdays_2012+bbloso_pdays_2013

//timing variables 
egen bbloso_minfilldt = rowmin(bbloso_minfilldt_2007 bbloso_minfilldt_2008 bbloso_minfilldt_2009 bbloso_minfilldt_2010 bbloso_minfilldt_2011 bbloso_minfilldt_2012 bbloso_minfilldt_2013)
egen bbloso_maxfilldt = rowmax(bbloso_maxfilldt_2007 bbloso_maxfilldt_2008 bbloso_maxfilldt_2009 bbloso_maxfilldt_2010 bbloso_maxfilldt_2011 bbloso_maxfilldt_2012 bbloso_maxfilldt_2013)

gen bbloso_fillperiod = bbloso_maxfilldt - bbloso_minfilldt + 1

gen bbloso_pdayspy = bbloso_pdays/bbloso_yearcount
gen bbloso_fdayspy = bbloso_fdays/bbloso_yearcount
gen bbloso_clmspy = bbloso_clms/bbloso_yearcount

sort bene_id
drop if bene_id==bene_id[_n-1]

compress
save "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Data/poly/bbloso_0713p.dta", replace
